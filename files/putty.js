/*
Based on Ball Pool by Mr. Doob http://mrdoob.com/
*/
...
function createBall( x, y ) {
	...
	graphics.drawImage(images[Math.floor(Math.random()*images.length)], 0, 0, size, size);
...
*/
	...
	box.extents.Set(size * 0.4,size * 0.4);
    	box.density = 1;
	box.friction = 0.2;
	box.restitution = 0.7;
...
function setWalls() {
	...
	//walls[4] = createBox(world, stage[2] / 2, (stage[3] / 2) + 22, 325, 158);
